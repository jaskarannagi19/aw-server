...
class ServerAPI:
    ...
    def create_userinfo(self, name,age,email,userfrom,timeskills,unproductive_websites,productive_websites):
        """Create userinfo."""
        return self.db.create_userinfo(name,age,email,userfrom,timeskills,unproductive_websites,productive_websites)
